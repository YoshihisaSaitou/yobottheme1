...
/**
 * Title: タイトルに詳細リンクで投稿内容の表示無し
 * Slug: solidseedblocktheme/post-list-custom-block-pattern-1
 * Categories: query
 * Description: タイトルに詳細リンクで投稿内容の表示無し
 */
?>

<!-- wp:query {"queryId":1,"query":{"perPage":"50","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"metadata":{"categories":["posts"],"patternName":"default-category/post-list-custom-block-pattern-1","name":"Post list custom block pattern 1"},"className":"post-list-custom-block-pattern-1","layout":{"type":"default"}} -->
<div class="wp-block-query post-list-custom-block-pattern-1"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"margin":{"top":"0","bottom":"var:preset|spacing|50"},"blockGap":"0"}},"layout":{"type":"default"}} -->
...
<!-- /wp:column -->
<!-- wp:column {"width":"100%"} -->
<div class="wp-block-column" style="flex-basis:100%"><!-- wp:post-title {"isLink":true,"style":{"typography":{"fontSize":"1rem","fontStyle":"normal","fontWeight":"bold"},"spacing":{"padding":{"top":"0"},"margin":{"top":"0","bottom":"0","left":"0","right":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|main-1"}}}},"textColor":"contrast"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
